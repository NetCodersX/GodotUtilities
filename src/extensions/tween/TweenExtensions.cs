...
public static class TweenExtensions
{
    ...
    public static void OnFinished(this Tween tween, Callable callable) =>
        tween.Connect(Tween.SignalName.Finished, callable, OneShotFlag);
    ...
    public static void OnFinished(this Tweener tween, Callable callable) =>
        tween.Connect(Tweener.SignalName.Finished, callable, OneShotFlag);

    public static void OnFinished(this Tweener tween, Action action) =>
        tween.Connect(Tweener.SignalName.Finished, Callable.From(action), OneShotFlag);
