...
public partial class HitboxComponent : Area2D
{
    ...
    private void OnAreaEntered(Area2D area)
    {
        ...
        Vector2 direction = hurtbox.GlobalPosition.DirectionTo(GlobalPosition);
        AttackData data = new(customDamageSource ?? this, damage, damageType, knockbackForce * direction);
